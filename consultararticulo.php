...
try {
    ...
    $resultado= $con->query ("SELECT * from articulo where fk_id_usuario !='".$id."'");
    $resultado->execute();
	...
	<article class="col-md-8">
	  <center>
		...
		<div class="container" style="background-color:#77e2a3; 
			...
			<label id="nombre"><b> <?php  echo $reg['nombre'] ?></b> </label>
			<br>
    		...
    		<div class="carousel-item active">
      			<img  class="d-block w-100" src="image/<?php  echo $reg['foto1'] ?>" alt="First slide" style="width: 100%; height: 100%">
    		</div>
    		<?php
    		for ($i=2; $i <=6 ; $i++) {
     			if (!empty($reg['foto'.$i])) {
    		...
    		<div class="carousel-item ">
    	  		<img class="d-block w-100" src="image/<?php echo $reg['foto'.$i]; ?>" alt="Second slide" style="width: 100%; height: 100%">
    		</div>
			<?php } } ?>
  			</div>
